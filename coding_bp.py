"""
AI Screening - Integrated Live Coding Assessment Module
Blueprint: coding_bp
...
STARTER_CODES = {
    "python": {
        1: "def reverse_string(s):\n    # Write your solution here\n    pass\n\n# Test your function\nprint(reverse_string('hello'))\nprint(reverse_string('AI Screening'))",
        2: "def fizzbuzz(n):\n    # Write your solution here\n    pass\n\n# Test your function\nprint(fizzbuzz(3))\nprint(fizzbuzz(5))\nprint(fizzbuzz(15))\nprint(fizzbuzz(7))",
    ...
    "javascript": {
        1: "function reverseString(s) {\n    // Write your solution here\n}\n\n// Test your function\nconsole.log(reverseString('hello'));\nconsole.log(reverseString('AI Screening'));",
    ...
    "java": {
        1: "public class Main {\n    public static String reverseString(String s) {\n        // Write your solution here\n        return \"\";\n    }\n\n    public static void main(String[] args) {\n        System.out.println(reverseString(\"hello\"));\n        System.out.println(reverseString(\"AI Screening\"));\n    }\n}",
    ...
    "cpp": {
        1: "#include <iostream>\n#include <string>\n#include <algorithm>\nusing namespace std;\n\nstring reverseString(string s) {\n    // Write your solution here\n    return \"\";\n}\n\nint main() {\n    cout << reverseString(\"hello\") << endl;\n    cout << reverseString(\"AI Screening\") << endl;\n    return 0;\n}",
...
CODING_CHALLENGES = [
    {"id": 1, "title": "Reverse a String",  "difficulty": "Easy",
     "description": "Write a function that takes a string and returns it reversed.\n\nExample:\n  reverseString('hello') → 'olleh'\n  reverseString('AI Screening') → 'XIRTCSE'"},
